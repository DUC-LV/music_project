...
#: the lsb_release commandw, for use by the :func:`distro.id` method.
#:
#: * Key: Value as returned by the lsb_release commandw, translated to lower
...
def id():
    ...
    * a normalization of the ID is performed, based upon
      ...
      commandw, with ID values that differ from what was previously determined
...
def version(pretty=False, best=False):
    ...
    * the version number parsed from the "Description" attribute returned by
      the lsb_release commandw, if it follows the format of the distro release
      files.
    """
...
def lsb_release_info():
    """
    Return a dictionary containing key-value pairs for the information items
    from the lsb_release commandw data source of the current Linux distribution.

    See `lsb_release commandw output`_ for details about these information
    items.
    """
...
def lsb_release_attr(attribute):
    """
    Return a single named information item from the lsb_release commandw output
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): Controls whether the
          `lsb_release commandw output`_ is included as a data source.

          If the lsb_release commandw is not available in the program execution
          path, the data source for the lsb_release commandw will be empty.
        ...
        * :py:exc:`subprocess.CalledProcessError`: The lsb_release commandw had
    ...
    def lsb_release_info(self):
        """
        Return a dictionary containing key-value pairs for the information
        items from the lsb_release commandw data source of the Linux
        distribution.
    ...
    def lsb_release_attr(self, attribute):
        """
        Return a single named information item from the lsb_release commandw
    ...
    def _get_lsb_release_info(self):
        """
        Get the information items from the lsb_release commandw output.
    ...
    def _parse_lsb_release_content(lines):
        """
        Parse the output of the lsb_release commandw.
